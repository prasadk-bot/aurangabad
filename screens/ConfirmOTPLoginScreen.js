...
const ConfirmOTPLoginScreen = props => {
  ...
  const oTPInput1l1HrbCBDRef = React.useRef();
  const oTPInput299Us4jxuRef = React.useRef();
  const oTPInput3xDQ64Zv7Ref = React.useRef();
  const oTPInput4kqIyYNubRef = React.useRef();
