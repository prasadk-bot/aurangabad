                        ...
                        <Touchable
                          onPress={() => {
                            try {
                              ...
                              const valueAyCyKRf5 = listData?.billingStatus;
                              setBillIssuee(valueAyCyKRf5);
                              const bs = valueAyCyKRf5;
                              setBillIssuee(bs);
                            ...
                            <RadioButton
                              ...
                              onPress={() => {
                                try {
                                  ...
                                  const valuebj0QdTF8 = listData?.billingStatus;
                                  setBillIssuee(valuebj0QdTF8);
                                  const bs = valuebj0QdTF8;
                                  setBillIssuee(bs);
                                } catch (err) {
                                  console.error(err);
                                }
